...
const Card = ({ title , target , imageUrl }) => {
  return (
    <div className="bg-gray-300 mx-8 rounded-2xl px-3 py-5 flex flex-col items-center col-span-3">
      <img src={imageUrl} alt={title} className='w-96 h-64'/>
      <h2 className='text-2xl text-gray-600 my-3 font-semibold'>{title}</h2>
